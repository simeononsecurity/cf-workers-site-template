...
    return Response.redirect("/index.xml", 301);
  } else if (url.pathname.startsWith("/fr/")) {
    return Response.redirect(`https://fr.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/es/")) {
    return Response.redirect(`https://es.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/de/")) {
    return Response.redirect(`https://de.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/hi/")) {
    return Response.redirect(`https://hi.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/ar/")) {
    return Response.redirect(`https://ar.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/ca/")) {
    return Response.redirect(`https://ca.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/it/")) {
    return Response.redirect(`https://it.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/ja/")) {
    return Response.redirect(`https://ja.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/nl/")) {
    return Response.redirect(`https://nl.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/ro/")) {
    return Response.redirect(`https://ro.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/zh/")) {
    return Response.redirect(`https://zh.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/pa/")) {
    return Response.redirect(`https://pa.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/pt/")) {
    return Response.redirect(`https://pt.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  } else if (url.pathname.startsWith("/ru/")) {
    return Response.redirect(`https://ru.simeononsecurity.ch${url.pathname.substr(3)}`, 301);
  }
